"""
Summary Service — Logger

challenge_service/logger.py pattern'ini takip eder.
logs/summary_service/ altına system, errors, api loglarını yazar.
"""
...
_LOG_DIR = Path(__file__).resolve().parent.parent.parent / "logs" / "summary_service"
_LOG_DIR.mkdir(parents=True, exist_ok=True)

SUMMARY_SERVICE_LOGGING: dict[str, Any] = {
    "version": 1,
...
start_logging(SUMMARY_SERVICE_LOGGING)
logger = get_logger("summary_service")
_logger = logger

__all__ = ["SUMMARY_SERVICE_LOGGING", "get_logger", "logger", "_logger"]