...
_LOG_DIR = Path(__file__).resolve().parent.parent.parent / "logs" / "this_month"
_LOG_DIR.mkdir(parents=True, exist_ok=True)

THIS_MONTH_SERVICE_LOGGING: dict[str, Any] = {
    "version": 1,
...
start_logging(THIS_MONTH_SERVICE_LOGGING)
_logger = get_logger("this_month")
